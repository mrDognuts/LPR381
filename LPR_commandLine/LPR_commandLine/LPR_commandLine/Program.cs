...
namespace LPR381_Project
{
    ...
    {
        public static string inputFile = @"C:\Users\walte\Downloads\LPR_commandLine_v3 (2)\LPR_commandLine_v3\LPR_commandLine\LPR_commandLine\LP.txt";
        ...
        private static ISimplexAlgorithm _simplexAlgorithm;
            ...
            while (true)
            {
                ...
                switch (choice)
                {
                    ...
                    case "6":
                        ...
                        CuttingPlane cuttingPlane = new CuttingPlane(model, _simplexAlgorithm, dualSimplex);
                        cuttingPlane.Solve();
                        break;
                    case "7":
                        return;
